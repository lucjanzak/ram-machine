...
export namespace Nodes {
  ...
  export const statusProgramCounter = element("#status-program-counter");
  export const statusRealTime = element("#status-real-time");
  export const statusAverageSpeed = element("#status-average-speed");
  export const statusMemoryComplexity = element("#status-memory-complexity");
  export const statusMemoryComplexityLog = element("#status-memory-complexity-log");
  export const statusTimeComplexity = element("#status-time-complexity");
  export const statusTimeComplexityLog = element("#status-time-complexity-log");
  export const statsTbody = element("#stats-body");
