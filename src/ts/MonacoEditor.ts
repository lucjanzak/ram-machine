  ...
  monaco.languages.registerCompletionItemProvider("ramMachineAssembly", {
    provideCompletionItems: (model, position) => {
      ...
      const suggestions: monaco.languages.CompletionItem[] = [
        ...
        {
          label: "if r₀ <= 0",
          detail: "if statement with JGTZ",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: ["; if r₀ <= 0", "JGTZ ${1:endif}", "\t${0:; code ...}", "$1:", ""].join("\n"),
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          range: range,
        },
        {
          label: "if r₀ != 0",
          detail: "if statement with JZERO",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: ["; if r₀ != 0", "JZERO ${1:endif}", "\t${0:; code ...}", "$1:", ""].join("\n"),
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          range: range,
        },
        {
          ...
          detail: "if statement with JGTZ",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: ["; if r₀ > 0", "JGTZ ${1:if}", "JUMP ${2:endif}", "$1:", "\t${0:; code ...}", "$2:", ""].join("\n"),
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          range: range,
        },
        {
          ...
          detail: "if statement with JZERO",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: ["; if r₀ == 0", "JZERO ${1:if}", "JUMP ${2:endif}", "$1:", "\t${0:; code ...}", "$2:", ""].join("\n"),
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
          range: range,
        },
        {
          label: "if-else r₀ <= 0",
          detail: "if-else statement with JGTZ",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: [
            "; if r₀ <= 0",
            "JGTZ ${1:else}",
        ...
        {
          label: "if-else r₀ != 0",
          detail: "if-else statement with JZERO",
          kind: monaco.languages.CompletionItemKind.Snippet,
          insertText: [
            "; if r₀ != 0",
            "JZERO ${1:else}",
